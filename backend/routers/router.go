...
func InitRouter() *gin.Engine {
	...
	apiV1 := r.Group("/api/v1")
	{
		...
		apiV1.GET("/user_members_faculty_brief", v1.UserMemberFacultyBrief)
		apiV1.GET("/user_members_students_brief", v1.UserMemberStudentsBrief)
		apiV1.GET("/user_members_alumni_brief", v1.UserMemberAlumniBrief)
		apiV1.GET("/contest_list_brief", v1.ContestListBrief)
		apiV1.GET("/contest_list", v1.ContestListFront)
