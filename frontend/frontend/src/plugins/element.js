...
import { Button, Form, FormItem, Input, Message, Container,
  ...
  Divider, DatePicker, InputNumber, Autocomplete, Tabs, TabPane, Upload } from 'element-ui'
...
Vue.use(InputNumber);Vue.use(Autocomplete);Vue.use(TabPane);Vue.use(Tabs);Vue.use(Upload);
